...
part of '../abstract/sight_client.dart';
...
class _SightsClient implements SightsClient {
  ...
  Future<List<SightDto>> getAllSights() async {
    ...
    final _options = _setStreamType<HttpResponse<List<SightDto>>>(
  ...
  Future<SightDto> getOneSight(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<SightDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/sight/${id}',
    ...
    late SightDto _value;
    try {
      _value = SightDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
